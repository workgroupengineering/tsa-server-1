...
/**
 * @implNote This is an exact copy of the {@link dev.mieser.tsa.signing.BouncyCastleTsaProperties} class. This class is
 * part of the exported module classes though.
 */
@Getter
@Setter
@EqualsAndHashCode
@ConfigurationProperties(prefix = "tsa")
public class TsaConfigurationProperties {
